...
| :--- | :--- | :---: |
| **Облачный сервер (VPS)** | Yandex Cloud / Selectel (4 vCPU, 8 GB RAM) для API и БД | ~4 500 ₽ |
...
| **LLM API** | Groq (Pay-as-you-go) + Gemini fallback (при объеме ~1000 запросов/мес) | ~2 000 ₽ |
| **Интеграции** | n8n (self-hosted, бесплатно) + Bitrix24 (1 лицензия) | ~1 500 ₽ |
...
#### ⚙️ Что именно автоматизируем и почему
